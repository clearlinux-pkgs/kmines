...
Source0  : https://download.kde.org/stable/release-service/24.08.1/src/kmines-24.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.1/src/kmines-24.08.1.tar.xz.sig
...
%setup -q -n kmines-24.08.1
cd %{_builddir}/kmines-24.08.1
pushd ..
cp -a kmines-24.08.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726179869
mkdir -p clr-build
pushd clr-build
