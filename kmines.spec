...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/kmines-22.08.0.tar.xz
...
%prep
%setup -q -n kmines-22.08.0
cd %{_builddir}/kmines-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661544828
mkdir -p clr-build
pushd clr-build
