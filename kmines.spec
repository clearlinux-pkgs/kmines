...
Source0  : https://download.kde.org/stable/release-service/24.08.0/src/kmines-24.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.0/src/kmines-24.08.0.tar.xz.sig
...
%setup -q -n kmines-24.08.0
cd %{_builddir}/kmines-24.08.0
pushd ..
cp -a kmines-24.08.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724519849
mkdir -p clr-build
pushd clr-build
