...
Source0  : https://download.kde.org/stable/release-service/22.12.3/src/kmines-22.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.3/src/kmines-22.12.3.tar.xz.sig
...
%prep
%setup -q -n kmines-22.12.3
cd %{_builddir}/kmines-22.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677787347
mkdir -p clr-build
pushd clr-build
