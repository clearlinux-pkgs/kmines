...
Source0  : https://download.kde.org/stable/release-service/20.12.0/src/kmines-20.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.12.0/src/kmines-20.12.0.tar.xz.sig
...
%prep
%setup -q -n kmines-20.12.0
cd %{_builddir}/kmines-20.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607720442
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kmines-20.12.0/COPYING %{buildroot}/usr/share/package-licenses/kmines/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/kmines-20.12.0/COPYING.DOC %{buildroot}/usr/share/package-licenses/kmines/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
cp %{_builddir}/kmines-20.12.0/LICENSE %{buildroot}/usr/share/package-licenses/kmines/2169315544493c7e4a5dd8bac41b70ab63ec417e
pushd clr-build
%make_install
popd
%find_lang kmines
